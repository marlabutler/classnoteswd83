...
british.push("MINI"); // appends to the end of an array
// console.log(british)

british.splice(0, 2, "Jaguar", "Rolls Royce"); // index to start, how many to remove, what to replace item with
console.log(british)

let bReturn = british.pop(); // remove last index of an array, "MINI" and returns it for brief moment
...
console.log(british.indexOf("Land Rover")); // searches an array for an index of elements. Can add second param to select start index
...
// array.forEach() runs a function for each element in an array MOST POWERFRUL and will be interviewed on this

german.forEach(car => console.log(car))
// same as    (function(car) { console.log(car)}) 

// array.map() -> transform elements in original array by callback function and returns a new, modified array
...
// Objects
/* Containers for values in a JSON format (JavaScript Object Notation). How data is passed around the Web
    - exists as a string
